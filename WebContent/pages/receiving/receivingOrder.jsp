...
<!-- Demo page code -->
    <script language="javascript">
        $(document).ready(function() {
            var t9 = new PopupLayer({trigger:"#ele9",popupBlk:"#blk9",closeBtn:"#close9",useOverlay:true,useFx:true,popupLayerClass:"#container-fluid",
                offsets:{
                    x:0,
                    y:-41
                }
			...
			<div class="row-fluid">
                ...
                <div class="span9">
                    <div class="faq-content">
                        ...
                        <div class="well">
                            <h2>收货信息录入<input type="button" class="btn btn-primary pull-right" style="margin-top: 5px" value="返回" onclick="window.open('../receiving/receivingAdd.jsp','_self'); "/></h2>
                            <hr/>
                            <form>
                                <div id="myTabContent" class="tab-content row-fluid">
                                    <div class="tab-pane active in span3">
                                        <label>供应商</label>
                                        <input type="text" class="input-xlarge" readonly="readonly" value="001"/>
                                    </div>
                                    <div class="span3 control-group">
                                        <label>采购员</label>
                                        <input type="text" class="input-xlarge" readonly="readonly" value="张三"/>
                                    </div>
                                    <div class="span3 control-group">
                                        <label>付款方式</label>
                                        <input type="text" class="input-xlarge" readonly="readonly" value="现金"/>
                                    </div>
                                    <div class="span3 control-group">
                                        <label>审核人</label>
                                        <input type="text" class="input-xlarge" readonly="readonly" value="李四"/>
                                    </div>
                                </div>
                                <div id="myTabContent" class="tab-content row-fluid">
                                    <div class="tab-pane active in span3"   >
                                        <label>创建者</label>
                                        <input type="text" class="input-xlarge" readonly="readonly" value="王五"/>
                                    </div>
                                    <div class="span3 control-group">
                                        <label>创建时间</label>
                                        <input type="text" class="input-xlarge" readonly="readonly" value="2015-4-1"/>
                                    </div>
                                </div>
                            </form>
                        </div>
