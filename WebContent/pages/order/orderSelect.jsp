							...
							<form>
								<div id="myTabContent" class="tab-content row-fluid">
									<div class="tab-pane active in span3">
										<label>订单编号</label> <input type="text" class="input-xlarge" />
									</div>
									...
									<div class="span3 control-group">
										<label>付款方式</label> <select class="input-xlarge">
											<option>不限</option>
											<option>现金</option>
											<option>刷卡</option>
										</select>
								...
								<div id="myTabContent" class="tab-content row-fluid">
									<div class="tab-pane active in span3">
										...
										<div class="date form_date" data-date=""
											...
											<input type="text" id="rjrf" class="input-xlarge"
								...
								<tbody>
									<s:iterator value="list" var="order">
										<tr>
											...
											<td><a href="../order/getOrderDetail?id=<s:property value="#order.id" />"><i
													class="icon-pencil"></i></a> <a href="../order/deleteOrder?id=<s:property value="#order.id" />"
