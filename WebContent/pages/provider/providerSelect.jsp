			...
			<div class="row-fluid">
				<div class="span2">
					<div class="sidebar-nav">
                        ...
                        <ul id="accounts-menu" class="nav nav-list collapse in">
                            ...
                            <li class="active"><a href="../provider/getAllProvider1">供应商查询</a></li>
                        </ul>
				...
				<div class="span9">
					<div class="faq-content">
						...
						<div class="well">
							<h2>供应商信息查询</h2>
							<s:form action="/pages/provider/getAllProviderByAll" method="post" theme="simple">
								<div id="myTabContent" class="tab-content row-fluid">
									<div class="tab-pane active in span3">
										<label>供应商编号</label> <input type="text" class="input-xlarge" />
									</div>
									<div class="span3 control-group">
										<label>供应商名称</label> <input type="text" name="providerDto.name" class="input-xlarge" />
									</div>
									<s:hidden name="currentPage" value="1"></s:hidden>
                                    <s:hidden name="maxPageNumber"></s:hidden>
									<div class="span3 control-group">
										<label>供应商地址</label> <input type="text" name="providerDto.address" class="input-xlarge" />
									</div>

								</div>
								<div id="myTabContent" class="tab-content row-fluid">
									<div class="span3 control-group">
										<label>供应商电话</label> <input type="text" name="providerDto.phone" class="input-xlarge" />
									</div>
									<div class="span3 control-group">
										<label>供应商邮编</label> <input type="text" name="providerDto.postal" class="input-xlarge" />
									</div>
									<div class="span3 control-group">
									...
									<s:iterator value="list" var="provider">
										<tr>
											...
											<td><a href="../provider/provider.jsp?id=<s:property value="#provider.id" />&name=<s:property value="#provider.name" />&address=<s:property value="#provider.address" />&phone=<s:property value="#provider.phone" />&postal=<s:property value="#provider.postal" />"><i
													class="icon-pencil"></i></a> <a href="../provider/deleteProvider?id=<s:property value="#provider.id" />" role="button"
