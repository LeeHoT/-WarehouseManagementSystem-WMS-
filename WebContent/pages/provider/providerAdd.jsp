				...
				<div class="span2">
					<div class="sidebar-nav">
                        ...
                        <ul id="accounts-menu" class="nav nav-list collapse in">
                            <li class="active"><a href="../provider/providerAdd.jsp">供应商新增</a></li>
                ...
                <div class="span9">
                    <div class="faq-content">
                        ...
                        <div class="well">
                            <h2>新供应商录入</h2>
                            <hr/>
                            <s:form action="/pages/provider/addProvider" method="post" theme="simple">
                                <label>供应商名称</label>
                                <s:textfield name="providerDto.name" cssClass="span5"/>
                                <label>供应商地址</label>
                                <s:textfield name="providerDto.address" cssClass="span5"/>
                                <label>供应商电话</label>
                                <s:textfield name="providerDto.phone" cssClass="span5"/>
                                <label>供应商邮编</label>
                                <s:textfield name="providerDto.postal" cssClass="span5"/>
                                <hr/>
                                <div class="btn-toolbar">
                                    <s:submit class="btn btn-primary" value="添加"/>
                                    <s:reset class="btn btn-primary" value="清空"/>
                                </div>
                            </s:form>
                        </div>
                    </div>
